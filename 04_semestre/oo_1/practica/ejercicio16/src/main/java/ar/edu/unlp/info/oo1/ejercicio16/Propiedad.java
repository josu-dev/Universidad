...
public class Propiedad {
	...
	public Propiedad (String nombre, String descripcion, String direccion, double precioPorNoche, Usuario dueño, PoliticaCancelacion politica) {
		this.nombre = nombre;
	...
	public double calcularReembolso(DateLapse periodo, LocalDate fecha) {
		return this.politica.calcularReembolso(this, periodo, fecha);
	}	
}
