...
for msize in 0512 1024 2048 4096 ; do
    ...
    for nodes in 1 2 4 ; do
        ...
        for block_size in ${block_sizes[$key]} ; do
            ...
            sbatch -o $output -e $error -N $nodes --tasks-per-node=$cores_per_node --exclusive --wrap "mpirun ./$binary_name $msize $block_size"
        done
    done
done
