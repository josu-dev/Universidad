...
do
    ...
    echo "iteration,sended,recieved,expected_value,client_comm_time" > out_client_$EXPONENT.csv
    echo "iteration,sended,recieved,expected_value,server_comm_time" > out_server_$EXPONENT.csv
